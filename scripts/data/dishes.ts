...
export const dishes: Dish[] = [
  ...
  {
    id: 'tourte-de-blettes',
    name: { fr: 'Tourte de blettes', en: 'Swiss chard tourte' },
    description: {
      fr: 'Tourte niçoise sucrée aux blettes, pignons, raisins secs et pommes, sous une fine pâte saupoudrée de sucre glace.',
      en: 'Sweet Niçois pie of Swiss chard, pine nuts, raisins and apple, in a thin pastry dusted with icing sugar.',
    },
    category: 'pastry',
    region: 'Nice',
    location: { type: 'commune', insee: '06088' },
  ...
  {
    id: 'pommes-sarladaises',
    name: { fr: 'Pommes sarladaises', en: 'Pommes sarladaises' },
    description: {
      fr: 'Pommes de terre rissolées dans la graisse de canard avec ail et persil, accompagnement périgourdin.',
      en: 'Potatoes pan-fried in duck fat with garlic and parsley, a Périgord side dish.',
    },
    category: 'side',
    region: 'Périgord',
    location: { type: 'area', name: 'Périgord', centroid: [0.95, 45.0] },
  ...
  },
  {
    ...
    name: { fr: 'Saucisse de Toulouse', en: 'Toulouse sausage' },
    description: {
      fr: 'Grosse saucisse fraîche de pur porc en boyau naturel, grillée ou intégrée au cassoulet.',
      en: 'Plump fresh pure-pork sausage in a natural casing, grilled or used in cassoulet.',
    },
    category: 'charcuterie',
    region: 'Toulouse',
    location: { type: 'commune', insee: '31555' },
  },
  {
  ...
  {
    id: 'clafoutis',
    name: { fr: 'Clafoutis aux cerises', en: 'Cherry clafoutis' },
    description: {
      fr: 'Flan limousin aux cerises noires non dénoyautées, cuit dans un appareil à pâte sucrée.',
      en: 'Limousin baked custard of unpitted black cherries set in a sweet batter.',
    },
    category: 'dessert',
    region: 'Limousin',
    location: { type: 'area', name: 'Limousin', centroid: [1.5, 45.7] },
  },
  {
    id: 'pate-aux-pommes-de-terre',
    name: { fr: 'Pâté aux pommes de terre', en: 'Potato pie' },
    description: {
      fr: 'Tourte limousine de pommes de terre en lamelles, ail et persil à la crème, en pâte feuilletée dorée.',
      en: 'Limousin pie of sliced potatoes, garlic and parsley with cream, baked in golden puff pastry.',
    },
    category: 'main',
    region: 'Limousin',
    location: { type: 'area', name: 'Limousin', centroid: [1.5, 45.7] },
  ...
  {
    id: 'poulet-au-vin-jaune',
    name: {
      fr: 'Poulet au vin jaune et morilles',
      en: 'Chicken with vin jaune and morels',
    },
    description: {
      fr: 'Volaille braisée à la crème, au vin jaune AOP du Jura et aux morilles séchées.',
      en: 'Chicken braised with cream, PDO Jura vin jaune and dried morels.',
    },
    category: 'main',
    region: 'Jura',
    location: { type: 'area', name: 'Jura', centroid: [5.7, 46.7] },
  },
  {
    ...
    category: 'cheese-dish',
    region: 'Haut-Doubs',
    location: { type: 'area', name: 'Haut-Doubs', centroid: [6.35, 46.85] },
  },
  {
    id: 'saucisse-de-morteau',
    name: { fr: 'Saucisse de Morteau', en: 'Morteau sausage' },
    description: {
      fr: 'Grosse saucisse fumée IGP du Haut-Doubs, reconnaissable à sa cheville de bois, fumée au tuyé.',
      en: 'Large PGI smoked sausage from the Haut-Doubs, identifiable by its wooden peg, smoked in a tuyé.',
    },
    category: 'charcuterie',
    region: 'Morteau',
    location: { type: 'commune', insee: '25411' },
  },
  {
    id: 'cancoillotte',
    name: { fr: 'Cancoillotte', en: 'Cancoillotte' },
    description: {
      fr: 'Fromage fondu coulant de Franche-Comté à base de metton, servi chaud sur pommes de terre ou pain.',
      en: 'Runny melted Franche-Comté cheese made from metton, served warm over potatoes or bread.',
    },
    category: 'cheese-dish',
    region: 'Franche-Comté',
    location: { type: 'area', name: 'Franche-Comté', centroid: [6.0, 47.1] },
  },
  ...
  },
  {
    ...
    name: { fr: 'Saucisson brioché', en: 'Saucisson brioché' },
    description: {
      fr: 'Saucisson lyonnais poché puis cuit en brioche, servi tiède en tranches épaisses.',
      en: 'Lyonnaise sausage poached then baked inside a brioche, served warm in thick slices.',
    },
    category: 'charcuterie',
    region: 'Lyon',
    location: { type: 'commune', insee: '69123' },
...

  {
    ...
    category: 'main',
    region: 'Champagne',
    location: { type: 'commune', insee: '51507' },
  },
  {
    id: 'andouillette-de-troyes',
    name: { fr: 'Andouillette de Troyes', en: 'Andouillette de Troyes' },
    description: {
      fr: 'Andouillette « à la ficelle » : lanières de chaudin de porc assemblées à la main, grillée et servie à la moutarde.',
      en: 'Hand-tied andouillette of pork chitterling cut into strips, grilled and served with mustard.',
    },
    category: 'charcuterie',
    region: 'Troyes',
    location: { type: 'commune', insee: '10387' },
  },
  {
    id: 'biscuit-rose-de-reims',
    name: { fr: 'Biscuit rose de Reims', en: 'Pink biscuit of Reims' },
    description: {
      fr: 'Biscuit léger et sec teinté de rose, saupoudré de sucre glace, créé à Reims au XVIIᵉ siècle et traditionnellement trempé dans le champagne.',
      en: 'Light dry pink-tinted biscuit dusted with icing sugar, created in Reims in the 17th century and traditionally dipped in champagne.',
    },
    category: 'pastry',
    region: 'Reims',
    location: { type: 'commune', insee: '51454' },
  },
  {
    id: 'boudin-blanc-de-rethel',
    name: { fr: 'Boudin blanc de Rethel', en: 'Boudin blanc de Rethel' },
    description: {
      fr: 'Boudin blanc IGP de pur porc, sans amidon ni œufs, fabriqué dans les Ardennes.',
      en: 'PGI pure-pork white boudin from the Ardennes, made without starch or eggs.',
    },
    category: 'charcuterie',
    region: 'Ardennes',
    location: { type: 'commune', insee: '08362' },
  },
  ...
  },
  {
    ...
    name: { fr: 'Marmite dieppoise', en: 'Marmite dieppoise' },
    description: {
      fr: 'Soupe-plat de poissons, moules et crevettes au cidre et à la crème, créée à Dieppe.',
      en: 'Hearty stew of fish, mussels and prawns in cider and cream, created in Dieppe.',
    },
    category: 'main',
    region: 'Dieppe',
    location: { type: 'commune', insee: '76217' },
  },
  ...
  {
    id: 'boudin-noir',
    name: { fr: 'Boudin noir', en: 'Boudin noir' },
    description: {
      fr: 'Boudin de sang de porc et oignons, poêlé et servi avec des pommes ou de la purée.',
      en: 'Pork-blood and onion sausage, pan-fried and served with apples or mashed potato.',
    },
    category: 'charcuterie',
    region: 'France',
    location: { type: 'national' },
  ...
  },
  {
    ...
    category: 'cheese-dish',
    region: 'Avesnois',
    location: { type: 'commune', insee: '59384' },
  },
  {
    id: 'tarte-au-sucre',
  ...
  {
    id: 'farci-poitevin',
    name: { fr: 'Farci poitevin', en: 'Farci poitevin' },
    description: {
      fr: 'Pain de légumes verts (chou, oseille, blettes, épinards) lié aux œufs et au lard, cuit enveloppé de feuilles de chou.',
      en: 'Loaf of green vegetables (cabbage, sorrel, chard, spinach) bound with eggs and bacon, cooked wrapped in cabbage leaves.',
    },
    category: 'main',
    region: 'Poitou',
    location: { type: 'area', name: 'Poitou', centroid: [0.3, 46.4] },
  },
  {
    id: 'tourteau-fromager',
    name: { fr: 'Tourteau fromager', en: 'Tourteau fromager' },
    description: {
      fr: 'Gâteau poitevin au fromage de chèvre frais, à la croûte volontairement noircie et bombée.',
      en: 'Poitou cake made with fresh goat cheese, with a deliberately blackened domed crust.',
    },
    category: 'pastry',
    region: 'Poitou',
    location: { type: 'area', name: 'Poitou', centroid: [0.3, 46.4] },
  ...
  {
    id: 'mogettes-de-vendee',
    name: { fr: 'Mogettes de Vendée', en: 'Vendée mogettes' },
    description: {
      fr: 'Haricots blancs IGP de Vendée mijotés au bouillon, traditionnellement servis sur tartine beurrée avec du jambon.',
      en: 'Stewed PGI Vendée white beans, traditionally served on buttered bread with ham.',
    },
    category: 'side',
    region: 'Vendée',
    location: { type: 'department', code: '85' },
  },
  {
  ...
  {
    id: 'figatellu',
    name: { fr: 'Figatellu', en: 'Figatellu' },
    description: {
      fr: 'Saucisse corse de foie de porc séchée ou fumée, grillée à la cheminée et servie avec de la pulenta.',
      en: 'Corsican pork-liver sausage, dried or smoked, grilled over an open fire and served with pulenta.',
    },
    category: 'charcuterie',
    region: 'Corse',
    location: { type: 'region', code: '94' },
